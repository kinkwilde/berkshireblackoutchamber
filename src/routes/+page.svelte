<div class="container py-12">
	<div class="mx-auto mb-12 max-w-prose text-center [&_p:last-of-type]:mb-0">
		<h1>Welcome to the Berkshire Blackout Chamber!</h1>
		<p>
			A DayZ server located in Europe with the unique challenge of a winter survival experience.
			...
			survival in Winter Chernarus awaits!
		</p>
		<p>
			<span class="block font-bold">Join the Discord</span>
			<a href="https://discord.gg/k9fRuhe5kw" target="_blank">https://discord.gg/k9fRuhe5kw</a>
		</p>
	</div>
</div>
